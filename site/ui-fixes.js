...
const fixImages=()=>{
 document.querySelectorAll('img').forEach(img=>{
  try{const u=new URL(img.src,location.origin);const p=u.pathname;if(map[p]&&p!==map[p])img.src=map[p]+'?v=20260830-clean';}catch(_){ }
 });
};
